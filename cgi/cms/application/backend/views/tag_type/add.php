...
<?php endforeach;?>
      ...
      <div id="subpanel">
        <form action="<?php echo base_url('tag_type/add')?>" method="post" name="myform" id="myform">
          <div class="item"><label class="item-title" for="typename">标签类型名称：</label><input type="text" class="input-txt long" name="typename" id="typename" /></div>
          <div class="item"><label class="item-title" for="typename_en">标签类别 英文：</label><input type="text" class="input-txt long" name="typename_en" id="typename_en" /></div>
...
$().ready(function() {
    ...
    $("#myform").validate({
        ...
        messages: {
            typename: {
                maxlength: "标签类型名称不能超过255个字符。"
            },
            typename_en: {
                maxlength: "标签类别 英文不能超过255个字符。"
            },
            ord: {
