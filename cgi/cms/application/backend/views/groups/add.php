...
<?php foreach($allow as $ctrl => $controler):?>
            <tr>
              <td scope="row"><input type="checkbox" name="controler[]" id="<?php echo $ctrl;?>" class="controler" value="<?php echo $ctrl;?>" /><?php echo $controler['title'];?></th>
              <td>
<?php foreach($controler['auth'] as $do => $method):?>
                <lable><input type="checkbox" name="<?php echo $ctrl;?>[]" id="<?php echo $ctrl;?>-<?php echo $do;?>" class="<?php echo $ctrl;?>" value="<?php echo $do;?>" /><?php echo $do;?></lable>
<?php endforeach;?>
              </td>
            </tr>
<?php endforeach;?>
