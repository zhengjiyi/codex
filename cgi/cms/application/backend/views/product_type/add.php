...
<?php endforeach;?>
      ...
      <div id="subpanel">
        <form action="<?php echo base_url('product_type/add')?>" method="post" name="myform" id="myform">
          <div class="item"><label class="item-title" for="type_name">系列：</label><input type="text" class="input-txt long" name="type_name" id="type_name" /></div>
          ...
          <div class="item"><label class="item-title" for="type_name_en">系列 英文：</label><input type="text" class="input-txt long" name="type_name_en" id="type_name_en" /></div>
...
$().ready(function() {
    ...
    $("#myform").validate({
        ...
        messages: {
            type_name: {
                maxlength: "系列不能超过255个字符。"
            },
            type_name_en: {
                maxlength: "系列 英文不能超过255个字符。"
            },
            ord: {
