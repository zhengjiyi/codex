...
<?php endif; ?>
      <div class="clear"></div>
      <div id="subpanel">
        <h3 class="cut-off"><span>基本信息</span><?php if (in_array('edit', $auth['setup']['edit'])): ?><a href="<?php echo base_url('setup/edit/'.$setup->id)?>">编辑</a><?php endif;?></h3>
        <table class="col-list" width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr>
            <th width="100px;" scope="row">项目：</th>
            <td><?php echo $setup->item;?></td>
          </tr>
          <tr>
            <th width="100px;" scope="row">别名：</th>
            <td><?php echo $setup->alias;?></td>
          </tr>
          <tr>
            <th width="100px;" scope="row">内容：</th>
            <td><?php echo $setup->content;?></td>
          </tr>
        </table>
      </div>
    </div>
