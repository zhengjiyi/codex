  ...
  <div id="main">
    ...
    <div id="panel">
      <div id="headbar">
        <div id="topitems">
          <ul>
            <li><a href="<?php echo base_url('catalog/edit/'.$current.'/'.$catalog->id)?>">基本信息</a></li>
      ...
      <div class="clear"></div>
      <div id="subpanel">
        <form action="<?php echo base_url('catalog/seo/'.$current.'/'.$catalog->id)?>" method="post" name="myform" id="myform">
          <div class="item"><label class="item-title" for="title">SEO标题：</label><input type="text" class="input-txt long" name="title" id="title" value="<?php echo empty($seo['title']) ? $catalog->name : $seo['title'];?>" /></div>
