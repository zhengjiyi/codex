      ...
      <div id="subpanel">
        ...
        <table class="col-list" width="100%" border="1" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td><?php if ($article->image):?><a href="<?php echo base_url("../../$article->image");?>" target="_blank"><img width="24" height="24" src="<?php echo base_url("../../$article->image");?>"></a><?php endif;?></td>
          </tr>
          <tr>
